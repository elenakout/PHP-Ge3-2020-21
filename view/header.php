...
<body>
  ...
  <header class="header">
    <a href=".">
      <img class="header__logo" src="assets/images/logo.svg" alt="logo university thessaloniki" />
    </a>
    ...
    <div class="header__user">
      ...
      <div class="header__buttons">
        <a href="./login.php" class="btn btn-light">dashboard</a>
        <a href="./logout.php" class="btn btn-light exit">εξοδος</a>
      </div>
